...
listen  "/data/www/conciage/shared/.unicorn.sock.0", :backlog => 64
...
pid "/data/www/conciage/shared/pids/unicorn.conciage.pid"
...
if env == "production"
  ...
  working_directory "/data/www/conciage/current"

  # feel free to point this anywhere accessible on the filesystem
  user 'deployer', 'deployer'
  # shared_path = "/home/deployer/apps/my_site/shared"
  shared_path = "/data/www/conciage/shared"
